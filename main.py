...
xml_path = r"E:\VS Code Outputs\Python\Underlined Text Extractor with Tesseract\outXML.xml"
pdf_path = r"E:\VS Code Outputs\Python\Underlined Text Extractor with Tesseract\loremIpsum.pdf"
